...
export const constructionLog: ConstructionMonth[] = [
  {
    ...
    photos: [
      { file: 'mar-01.jpg', alt: 'Будівельний майданчик, березень 2026', caption: 'Бетонна рама, опалубка верхніх перекриттів' },
      { file: 'mar-02.jpg', alt: 'Будівельний майданчик, березень 2026', caption: 'Балкон з готовим оздобленням — дерев’яні панелі, скління' },
      { file: 'mar-03.jpg', alt: 'Будівельний майданчик, березень 2026', caption: 'Монолітні роботи на двох секціях, кран між ними' },
      { file: 'mar-04.jpg', alt: 'Будівельний майданчик, березень 2026', caption: 'Фасад з вентильованими панелями, вікна встановлено' },
      { file: 'mar-05.jpg', alt: 'Будівельний майданчик, березень 2026', caption: 'Цегляний фасад, металеві рами вікон' },
      { file: 'mar-06.jpg', alt: 'Будівельний майданчик, березень 2026', caption: 'Кут секції знизу — фасадні панелі та цегляне ядро' },
      { file: 'mar-07.jpg', alt: 'Будівельний майданчик, березень 2026', caption: 'В’язання арматури на майданчику' },
      { file: 'mar-08.jpg', alt: 'Будівельний майданчик, березень 2026', caption: 'Підготовка опалубки наступного перекриття' },
      { file: 'mar-09.jpg', alt: 'Будівельний майданчик, березень 2026', caption: 'Заливання монолітного шару, вид з верхньої секції' },
      { file: 'mar-10.jpg', alt: 'Будівельний майданчик, березень 2026', caption: 'Бригада готує опалубку — місто на тлі' },
      { file: 'mar-11.jpg', alt: 'Будівельний майданчик, березень 2026', caption: 'Фасад верхньої секції, балкони ще без скління' },
      { file: 'mar-12.jpg', alt: 'Будівельний майданчик, березень 2026', caption: 'Опалубка перекриття: балка, стійки, арматурні випуски' },
      { file: 'mar-13.jpg', alt: 'Будівельний майданчик, березень 2026', caption: 'Кран на висоті, монолітний майданчик нижче' },
      { file: 'mar-14.jpg', alt: 'Будівельний майданчик, березень 2026', caption: 'Цегляний фасад сусідньої секції, ракурс з верхнього поверху' },
      { file: 'mar-15.jpg', alt: 'Будівельний майданчик, березень 2026', caption: 'Дві секції — бетонна рама ліворуч, цегляне заповнення праворуч' },
    ],
  },
  {
    key: 'feb-2026',
