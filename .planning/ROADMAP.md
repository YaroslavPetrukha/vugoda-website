...
**Plans**: 11 plans
  - [x] 04-01-stages-and-content-PLAN.md — src/lib/stages.ts + 3 content modules (Wave 1, foundation)
  - [x] 04-02-lightbox-PLAN.md — shared <Lightbox> primitive (Wave 1, LOG-01 + ZHK-01 dependency)
  - [x] 04-03-flagship-extract-PLAN.md — extract FlagshipCard + AggregateRow from home (Wave 1, HUB-02 + HUB-04)
...
**Plans**: 9 plans
  ...
  - [x] 05-04-reveal-home-page-PLAN.md — wrap 6 home sections with <RevealOnScroll> + 80ms staggers (BrandEssence + PortfolioOverview + MethodologyTeaser + TrustBlock) (Wave 3, ANI-02 home coverage)
  - [x] 05-05a-reveal-zhk-page-PLAN.md — wrap 5 /zhk/etno-dim sections (ZhkHero with fade variant per D-09; ZhkGallery as <ul>/<motion.li> 8-thumb stagger per D-05) (Wave 3, ANI-02 zhk coverage)
  - [x] 05-05b-reveal-other-routes-PLAN.md — wrap /projects (header + StageFilter chip stagger + PipelineGrid card stagger), /construction-log (per-MonthGroup per D-04), /contact (3 separate reveals per D-08) (Wave 3, ANI-02 other-routes coverage)
  - [x] 05-06-animate-presence-layout-PLAN.md — Layout.tsx AnimatePresence + onExitComplete; ScrollToTop.tsx deleted (Wave 3, ANI-04)
  - [x] 05-07-hero-session-skip-PLAN.md — useSessionFlag hook + Hero.tsx parallaxRange import + skipParallax (Wave 3, SC#5 + D-28)
...
**Plans**: 9 plans
  ...
  - [x] 06-05-lazy-routes-suspense-PLAN.md — MarkSpinner + App.tsx React.lazy 3 routes + Suspense fallback (Wave 2, QA-02 SC#3 lazy split)
...
**Plans**: 9 plans
  ...
  - [x] 07-04-hard-refresh-test-PLAN.md — 6-row cold-incognito-per-window deep-link table (Wave 2, SC#2 + UAT-4)
  ...
  - [x] 07-08-social-unfurl-verify-PLAN.md — 3 platform PNGs + unfurls/SUMMARY.md (Wave 3, UAT-3)
